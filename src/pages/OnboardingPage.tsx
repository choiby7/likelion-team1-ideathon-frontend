    ...
    <main className="min-h-screen bg-[#f1f4f8] flex justify-center">
      <section className="w-full max-w-[430px] min-h-screen bg-[#fafafa] px-6 pt-8 pb-8 relative">
        ...
        <section className="mt-16 text-center">
          <h2 className="text-[30px] font-extrabold leading-tight text-[#222]">
            말씀만 하세요,
            <br />
            책이 됩니다.
          </h2>
        ...
        <section className="mt-10 relative">
          <div className="absolute top-2 left-2 w-full h-full rounded-[34px] bg-[#eee7ad]" />
        ...
        <section className="mt-36 space-y-4">
          ...
          <button className="w-full h-[56px] rounded-[10px] bg-white border-[1.5px] border-[#222] text-[18px] text-[#333] transition duration-200 hover:bg-gray-100">
            전화번호로 시작하기
          </button>
        </section>
